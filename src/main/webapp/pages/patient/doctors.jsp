...
<!-- My scripts -->
	...
	<script type="text/javascript" src="${context}/static/js/patient/doctors/dataTableConfig.js"></script>
	<script type="text/javascript" src="${context}/static/js/patient/doctors/datePickerConfig.js"></script>
