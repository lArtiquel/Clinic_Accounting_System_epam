...
<!-- My scripts -->
	<script type="text/javascript" src="${context}/static/js/doctor/patients/dataTableConfig.js"></script>
	...
	<nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarAltContent">
			<div class="navbar-nav">
				...
				<a class="nav-item nav-link active" href="patients">Find Patient<span class="sr-only">(current)</span></a>
